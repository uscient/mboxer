...
Goal: inspect the current repo and produce a readiness map for making `mboxer` a strong future producer for uScientDB, without implementing uScientDB integration yet.
...
5. Identify fragile areas where future uScientDB integration could cause drift or coupling.
